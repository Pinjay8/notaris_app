...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => isset($cost) ? 'Edit Biaya' : 'Tambah Biaya'])
            ...
            <div class="card-body px-4 pt-3 pb-2">
                <form action="{{ isset($cost) ? route('notary_costs.update',$cost->id) : route('notary_costs.store') }}"
                    ...
                    <div class="mb-3">
                        ...
                        @error('pic_document_id') <p class="text-danger mt-2">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="product_cost" class="form-label text-sm">Biaya Produk</label>
                            ...
                            @error('product_cost') <p class="text-danger mt-2">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @error('admin_cost') <p class="text-danger mt-2">{{ $message }}</p> @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @error('other_cost') <p class="text-danger mt-2">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-md-6 mb-3 ">
                            ...
                            @error('amount_paid') <p class="text-danger mt-2">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="payment_status" id="payment_status" class="form-control form-control-sm">
                            ...
                            <option value="partial" {{ old('payment_status', $cost->payment_status ?? '') == 'partial' ?
                                'selected' : '' }}>Bayar Sebagian</option>
                            <option value="paid" {{ old('payment_status', $cost->payment_status ?? '') == 'paid' ?

                    ...
                    <form
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="client_code" class="form-control"
                                value="{{ old('client_code', $registrationCode ?? $document->client_code ?? '') }}"
                                readonly>
                        </div> --}}
                                ...
                                <select name="client_id"
                                    ...
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}"
                                            {{ old('client_id', $document->client_id ?? request('client_id')) == $client->id ? 'selected' : '' }}>
                                            {{ $client->fullname }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="document_code"
                                    ...
                                    @foreach ($documents as $doc)
                                        <option value="{{ $doc->code }}"
                                            {{ old('document_code', $document->document_code ?? '') == $doc->code ? 'selected' : '' }}>
                                            {{ $doc->name }}
                                        </option>
                                    @endforeach
                                </select>

            ...
            <div class="card shadow-sm">
                <div class="card-header pb-0">
                    ...
                    <small class="text-muted">
                        Download data notaris dalam format JSON
                    </small>
                </div>
                    ...
                    <form action="{{ route('backup') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="start_date" value="{{ now()->subYear()->toDateString() }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="mb-2">
                                        Restore akan memasukkan semua data yang ada di file backup.
                                    </p>
                                    <p class="text-danger small mb-0">
                                        Pastikan file yang Anda upload sudah benar.
                                    </p>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" form="restoreForm" class="btn btn-danger">
                                        Ya, Restore Sekarang
                                    </button>
                                </div>

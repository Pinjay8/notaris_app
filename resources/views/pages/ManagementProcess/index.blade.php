                    ...
                    <div class="table-responsive p-0">
                        <table class="table table-hover mb-0 table-responsive">
                            ...
                            <tbody>
                                    ...
                                    <tr class="text-center text-sm">
                                        ...
                                        <td class="d-flex flex-wrap mb-0 align-items-center gap-1">
                                            <button type="button" class="btn btn-info btn-xs" data-bs-toggle="modal"
                                                data-bs-target="#progressDetailModal-{{ $product->client_code }}">
                                                <i class="fa fa-info"></i>
                                            </button>
                                            {{-- Modal Detail Progress --}}
                                            <div class="modal fade" id="progressDetailModal-{{ $product->client_code }}"
                                                tabindex="-1"
                                                aria-labelledby="progressDetailLabel-{{ $product->client_code }}"
                                                aria-hidden="true">
                                                    ...
                                                    <div class="modal-content shadow-lg border-0 rounded-3">
                                                        ...
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title fw-bold text-white"
                                                                id="progressDetailLabel-{{ $product->client_code }}">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @else
                                                                <div class="timeline">
                                                                    <div class="container">
                                                                        <div class="row">
                                                                            @foreach ($progressList->sortByDesc('progress_date')->values() as $index => $item)
                                                                                <div
                                            ...
                                            <button type="button" class="btn btn-primary btn-xs" data-bs-toggle="modal"
                                                data-bs-target="#addProgressModal-{{ $product->client_code }}">
                                                <i class="fa fa-plus"></i>
                                            </button>

                                            {{-- Modal Tambah Progress --}}
                                            <div class="modal fade" id="addProgressModal-{{ $product->client_code }}"
                                                tabindex="-1"
                                                aria-labelledby="addProgressLabel-{{ $product->client_code }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lgmodal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('management-process.addProgress') }}">
                                                        @csrf
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="addProgressLabel-{{ $product->client_code }}">
                                                                    Tambah Progress Baru - {{ $product->client_code }}
                                                                </h5>
                                                                <button type="button" class="btn-close btn-close-white"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="date" class="form-control"
                                                                        name="progress_date" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="form-label text-start d-block">Catatan</label>
                                                                    <textarea class="form-control" name="note" rows="3"></textarea>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="form-label text-start d-block">Status</label>
                                                                    <input type="text" class="form-control"
                                                                        name="status">
                                                                </div>
                                                            </div>
                                            ...
                                            @if ($product->status !== 'done')
                                                <button type="button" class="btn btn-success btn-xs"
                                                    ...
                                                    data-bs-target="#markDoneModal-{{ $product->client_code }}">
                                                    <i class="fa fa-check"></i>
                                                </button>
                                                <div class="modal fade" id="markDoneModal-{{ $product->client_code }}"
                                                    tabindex="-1"
                                                    aria-labelledby="markDoneLabel-{{ $product->client_code }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('management-process.markDone') }}">
                                                            @csrf
                                                            <input type="hidden" name="client_code"
                                                                value="{{ $product->client_code }}">
                                                            <input type="hidden" name="notaris_id"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="markDoneLabel-{{ $product->client_code }}">
                                                                        Konfirmasi Selesai
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body text-wrap">
                                                                    ...
                                                                    <strong>{{ $product->client_code }}</strong> menjadi
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-muted text-sm">Data produk notaris
                                            tidak
                                            ditemukan.</td>
                                    </tr>
                                @endforelse

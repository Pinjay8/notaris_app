                        ...
                        <form method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                            ...
                            <div class="card-header pb-0 rounded-top">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-md ms-auto">Simpan
                                        Perubahan</button>
                                </div>
                            </div>
                            <div class="card-body pt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('first_name') is-invalid @enderror"
                                                ...
                                                value="{{ old('first_name', $notaris->first_name ?? '') }}">
                                            @error('first_name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('last_name') is-invalid @enderror"
                                                ...
                                                value="{{ old('last_name', $notaris->last_name ?? '') }}">
                                            @error('last_name')
                                                <p class="text-danger mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                class="form-control-label text-sm">Foto</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                class="form-control-label text-sm">Alamat</label>
                                            <input class="form-control @error('address') is-invalid @enderror"
                                                type="text" name="address"
                                                value="{{ old('address', $notaris->address ?? '') }}">
                                            @error('address')
                                                <p class="text-danger mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('no_telp') is-invalid @enderror"
                                                ...
                                                value="{{ old('no_telp', $notaris->no_telp ?? '') }}">
                                            @error('no_telp')
                                                <p class="text-danger mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                class="form-control-label text-sm">Email</label>
                                            <input class="form-control @error('email') is-invalid @enderror"
                                                type="email" name="email"
                                                value="{{ old('email', $notaris->email ?? '') }}">
                                            @error('email')
                                                <p class="text-danger mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label text-sm">SK
                                                PPAT</label>
                                            <input class="form-control @error('sk_ppat') is-invalid @enderror"
                                                type="text" name="sk_ppat"
                                                value="{{ old('sk_ppaat', $notaris->sk_ppat ?? '') }}">
                                            @error('sk_ppat')
                                                <p class="text-danger mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label text-sm">Tanggal
                                                SK
                                                PPAT</label>

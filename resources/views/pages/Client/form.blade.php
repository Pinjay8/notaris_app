                    ...
                    <form action="{{ isset($client) ? route('clients.update', $client->id) : route('clients.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="postcode" class="form-control" placeholder="Masukkan kode pos"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" name="email" class="form-control"
                                    placeholder="Masukkan alamat email" value="{{ old('email', $client->email ?? '') }}">
                                @error('email')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="type" class="form-select">
                                    ...
                                    <option value="company"
                                        {{ old('type', $client->type ?? '') == 'company' ? 'selected' : '' }}>Perusahaan
                                    </option>
                                </select>
                                @error('type')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    <option value="pending"
                                        {{ old('status', $client->status ?? '') == 'pending' ? 'selected' : '' }}>Pending
                                    </option>
                                    <option value="valid"
                        ...
                        <div class="mt-4">
                            ...
                            <button type="submit"
                                class="btn btn-primary">{{ isset($client) ? 'Ubah' : 'Simpan' }}</button>
                        </div>
                    </form>
                </div>
            </div>
